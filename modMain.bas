...
Public Sub mainRoutine(ByVal restart As Boolean)
    ...
    Call readSettingsFile("Software\PzJustClock", gblSettingsFile)
...
Private Sub checkFirstTime()
   ...
   On Error GoTo checkFirstTime_Error
    ...
    If gblFirstTimeRun = "true" Then
        ...
        sPutINISetting "Software\PzJustClock", "firstTimeRun", gblFirstTimeRun, gblSettingsFile
    End If
...
'        gblClockFaceSwitchPref = fGetINISetting(location, "clockFaceSwitchPref", gblSettingsFile)
        ...
        ' other
        gblClockHighDpiXPos = fGetINISetting("Software\PzJustClock", "clockHighDpiXPos", gblSettingsFile)
        gblClockHighDpiYPos = fGetINISetting("Software\PzJustClock", "clockHighDpiYPos", gblSettingsFile)
        
        gblClockLowDpiXPos = fGetINISetting("Software\PzJustClock", "clockLowDpiXPos", gblSettingsFile)
        gblClockLowDpiYPos = fGetINISetting("Software\PzJustClock", "clockLowDpiYPos", gblSettingsFile)
...
Private Sub getToolSettingsFile()
    ...
    gblSettingsDir = fSpecialFolder(feUserAppData) & "\PzJustClock" ' just for this user alone
...
Private Sub handleUnhideMode(ByVal thisUnhideMode As String)
    ...
    If thisUnhideMode = "unhide" Then     'parse the command line
        gblUnhide = "true"
        sPutINISetting "Software\PzJustClock", "unhide", gblUnhide, gblSettingsFile
